...
class DroneCategoryTests(APITestCase):
    ...
    def test_post_and_get_drone_category(self):
        ...
        self.assertEqual(new_drone_category_name,
                         DroneCategory.objects.get().name)
    ...
    def test_filter_drone_category_by_name(self):
        ...
        url = "{0}?{1}".format(
            reverse("dronecategory-list"), urlencode(filter_by_name))
        print(url)
        ...
        self.assertEqual(drone_category_name1,
 ...
 # Testa o retorno de coleção de categorias de drone
    ...
    def test_update_drone_category(self):
        ...
        self.assertEqual(updated_drone_category_name,
