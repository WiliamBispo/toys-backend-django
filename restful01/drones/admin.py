...
class DroneAdmin(admin.ModelAdmin):
    list_display = ('name', 'drone_category', 'manufacturing_date',
                    'has_it_competed', 'is_published', 'display_picture', 'owner')
    list_editable = ('is_published', 'drone_category')
    search_fields = ('name', 'drone_category__name', 'owner__username')
    list_filter = ('drone_category', 'has_it_competed',
                   'is_published', 'owner')
...
class CompetitionAdmin(admin.ModelAdmin):
    list_display = ("pilot", "drone", "distance_in_feet",
